...
{
    class ServicioWebNavision : GDatos
    {
        /*
        ...
        protected override System.Data.IDbCommand Comando(string procedimientoAlmacenado)
        {
            ...
            com.Transaction = (System.Data.SqlClient.SqlTransaction)MTransaccion[MTransaccion.Count - 1];
            return com;
        }// end Comando
        ...
        public ServicioWebNavision(string cadenaConexion)
        { CadenaConexion = cadenaConexion; }// end DatosSQLServer


        public ServicioWebNavision(string servidor, string @base)
        {
            Base = @base;
            Servidor = servidor;
        }// end DatosSQLServer
        ...
        public ServicioWebNavision(string servidor, string @base, string usuario, string password)
        {
            Base = @base;
            Servidor = servidor;
            Usuario = usuario;
